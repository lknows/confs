...
-- {{{ Main
theme = {}
theme.wallpaper = "/home/grant/Pictures/Wallpapers/killer.jpg"
-- }}}
...
-- {{{ Colors
theme.fg_normal  = "#7190C8"
theme.fg_focus   = "#5F9C6F"
